        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center content-center items-center gap-3 md:gap-8">
          ...
          <div className=" col-span-1">
            ...
            <p className="text-base text-gray-500 my-10">
              At Reef Tech, we are fervently dedicated to delivering
              cutting-edge technology experiences. Our mission is to ignite the
              curiosity of tech enthusiasts and assist them in exploring the
              world's most innovative and transformative developments, all while
              providing exceptional tech solutions and support.
            </p>
            <h1 className="text-2xl text-black font-semibold">Who We Are</h1>
            <p className="text-base text-gray-500 my-10">
              We are a team of dedicated tech enthusiasts, experts, and
              innovators who have explored every corner of the digital realm and
              want to share our passion with you. With years of experience in
              the tech industry, we've meticulously crafted a selection of
              unique and captivating tech solutions to satisfy every tech-savvy
              heart.
            </p>
